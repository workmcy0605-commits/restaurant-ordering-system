...
function getBackendMessage(data?: Partial<App.Service.Response<any>> | null) {
...
export const request = createFlatRequest(
  ...
  },
  {
    ...
    async onBackendFail(response, instance) {
      ...
      if (modalLogoutCodes.includes(responseCode) && backendMessage && !request.state.errMsgStack?.includes(backendMessage)) {
